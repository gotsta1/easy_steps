...
class Settings(BaseSettings):
    ...
    BOTHELP_RETENTION_REPEAT_MIN_DAYS: int = 2
    BOTHELP_RETENTION_REPEAT_MAX_DAYS: int = 4
    BOTHELP_RETENTION_SEND_START_HOUR_MSK: int = 6
    BOTHELP_RETENTION_SEND_END_HOUR_MSK: int = 24
